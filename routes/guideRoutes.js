...
router.post('/addDetails',upload.upload.single("image"),authMiddleware,guideController.addDetails)
router.post('/editprofile',upload.upload.single("image"),authMiddleware,guideController.editProfile)
